...
class TestUS22(unittest.TestCase):
    def test1Akin(self):
        INDI = []
        new_user = {'INDI': '@I11@', 'NAME': 'Hayley /Dunfee/', 'SEX': 'F', 'BIRT': '10 DEC 1993', 'FAMC': '@F1@'}
        persist(new_user)
        print(INDI)
    ...
    def test2Akin(self):
        ...
        try:
            ...
            dupID(new_user)
            self.fail("User attempted to add to dictionary with same ID as another user was not raised")
        except:
            pass
